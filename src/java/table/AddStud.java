 ...
 * @author 1406425
 */
@WebServlet(name = "AddStud", urlPatterns = {"/AdStu"})
public class AddStud extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String q = "insert into student(sid,password,sname,dept) values('"+s+"','"+p+"','"+n+"','"+d+"');";
        int ar = DAOLayer.updateData(q);
        out.println("<h1>STUDENT ADDED SUCCESFULLY</h1>"); 
    }
